...
CAPABILITY_STRATEGIES: dict[Capability, list[str]] = {
    Capability.PRICE_DATA: ["stooq", "fmp", "alphavantage", "polygon", "tiingo", "egx_official", "company_ir"],
    Capability.CORPORATE_DISCLOSURES: [
        "egx_official", "fra_egypt", "company_ir", "enterprise_press", "mubasher", "zawya",
    ],
    Capability.CORPORATE_ACTIONS: [
        "egx_official", "company_ir", "reuters", "enterprise_press", "mubasher", "zawya",
    ],
    Capability.FINANCIAL_STATEMENTS: ["company_ir", "fmp"],
    Capability.INVESTOR_RELATIONS: ["company_ir"],
    Capability.NEWS: [
        "reuters", "enterprise_press", "mubasher", "zawya", "asharq_business", "cnbc_arabia",
        "alarabiya_business", "marketscreener", "investing_news", "almal", "alborsa",
        "masrawy_economy", "youm7_economy", "skynews_arabia_economy", "asharq_economy",
    ],
    Capability.MACROECONOMIC: [
        "worldbank", "fred", "imf", "oecd", "undata", "trading_economics", "cbe", "mof_egypt", "capmas",
    ],
