// Mirrors the pydantic models in research/src/agx_research/{knowledge,events,meta,
// market_memory,runtime,sources,dashboard}/. This is a read-only view type set --
// the API never constructs or mutates any of these, it only serves what the
// Python research engine has already produced and persisted.
//
